...
const Inventories = React.lazy(() => import("../components/inventory/Inventories.jsx"))
    ...
    <div className="p-2">
      ...
      <div className="flex justify-between items-center text-black">
        ...
        {check ? (
          <>
            <button
              className="btn hover:bg-none hover:rounded-md"
              ...
              <div className="modal-box">
                <div className="flex justify-between items-center">
                  ...
                  <div className="modal-action">
                    <form method="dialog">
                      <button className="btn bg-transparent hover:bg-none hover:rounded-md">
                        <FaCut />
                      </button>
                    </form>
                  </div>
                ...
                <div>
                  ...
                  <div className="modal-action">
                    <form method="dialog">
                      <button
                        className="btn bg-transparent hover:bg-none hover:rounded-md px-7"
